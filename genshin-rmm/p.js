...
(async () => {
  for (const lang of ["zh_cn", "zh_tw", "en_us", "ko_kr", "ja_jp", "es_es", "fr_fr", "ru_ru", "th_th", "vi_vn", "de_de", "id_id", "pt_pt", "tr_tr", "it_it"]){
    const data = await fetch("https://sg-hk4e-api.hoyoverse.com/event/musicugc/v1/second_page?key=Button_Album_6_6Magic&is_from_button=true&page=1&page_size=30&lang=" + lang.replace("_", "-") + "&game_biz=hk4e_global&is_mobile=false&label_list=" + lang.replace("_", "-")).then(res => res.json());
